...
namespace ast{
   ...
   public:
      ...
      IfStatement(ast::Exp* condition, ast::Statement* true_branch, ast::Statement* false_branch):
   ...
   public:
      ...
      WhileStatement(ast::Exp* condition, ast::Statement* statement, bool is_do_while):
         condition(condition), statement(statement), is_do_while(is_do_while){};
      ast::Exp* condition;
   ...
   public:
      ...
      ast::Exp* condition;
      std::vector<ast::Statement*> before;
      std::vector<ast::Statement*> after;
      ast::Statement* statement;
   };
